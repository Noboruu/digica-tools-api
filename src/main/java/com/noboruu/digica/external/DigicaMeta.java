...
public class DigicaMeta {
    ...
    private final List<String> CARD_META_SETS = List.of(); // remove sets from here as they get released in global
    ...
    public boolean isToGetArtFromDigicaMeta(String cardCode) {
        ...
        if(PROMO_EXTRACTED_CARD_SET.equalsIgnoreCase(cardSet)) {
            return false; // get all promo cards from wiki
        }
